          ...
          <div class="col-lg-3"></div>
            <div class="col-lg-6">
              <div class="box">
                ...
                <hr>
                <form action="product-register.do" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="email-login">ProductName</label>
                    <input id="email-login" name="name" type="text" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="password-login">Price</label>
                    <input id="password-login" name="price" type="text" class="form-control">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input id="Phone-login" name="image" type="file" class="form-control">
                  </div>
