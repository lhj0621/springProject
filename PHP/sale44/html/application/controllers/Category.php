<?
    class Category extends CI_Controller {
		...
		$result=$this->category_m->deleterow($no);
		if($result) echo $no;
		}
		...
		redirect("/~sale44/category/lists/".$text1.$page);
		}
		...
		if ( $this->form_validation->run()==FALSE )
		{
         ...
         $result=$this->category_m->insertrow($data); 

        redirect("/~sale44/category/lists/".$text1.$page);    //   목록화면으로 이동.
			}
		}
