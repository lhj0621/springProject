...
<script>
    function find_text()
    {
        ...
        form1.action="/~sale44/member/lists";
		else		// 값이 있는 경우, text1 값 전달
        form1.action="/~sale44/member/lists/text1/" + form1.text1.value;
		form1.submit();
    }
</script>
...
?>
        ...
        <div class="col-8" align="right">           
             <a href="/~sale44/member/add<?=$tmp;?>" class="btn btn-sm mycolor1">추가</a>
        </div>
    </div>
</form>
...
<tr>
    <td><?=$no; ?></td>
    <td><a href="/~sale44/member/view/no/<?=$no ?><?=$tmp;?>"><?=$row->name44; ?></a></td>
    <td><?=$row->uid44; ?></td>
    <td><?=$row->pwd44; ?></td>
	<td><?=$tel; ?></td>
    <td><?=$rank; ?></td>
