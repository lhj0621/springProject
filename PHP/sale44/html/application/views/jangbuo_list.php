...
<script>
	function find_text()
	{
		form1.action="/~sale44/jangbuo/lists/text1/"+form1.text.value+"/page";
		form1.submit();
	}
...
?>
        ...
        <div class="col-9" align="right">           
             <a href="/~sale44/jangbuo/add<?=$tmp;?>" class="btn btn-sm mycolor1">추가</a>
        </div>
    </div>
</form>
...
<tr>
    ...
    <td align="left"><a href="/~sale44/jangbuo/view/no/<?=$no ?><?=$tmp;?>"><?=$row->product_name; ?></a></td>
	<td align="right"><?=number_format($row->price44) ?></td>
	<td align="right"><?=number_format($row->numo44) ?></td>
