...
<?
	...
	foreach($list as $row)
	{
		if($row->no44==$product_no)
			echo("<option value='$row->no44^^$row->price44' selected> $row->name44($row->price44)</option>");
		else
			echo("<option value='$row->no44^^$row->price44' > $row->name44($row->price44)</option>");
	}
?>
			</select>
        </div>
...
<tr>
    ...
    <td width="80%" align="left">
        <div class="form-inline">
            <input  type="text" name="price" value ="" class="form-control from-control-sm" onChange='cal_prices();'>
        </div>
    </td>
</tr>
<tr>
    <td width="20%" class="info mycolor2" style="vertical-align:middle">수량</td>
    <td width="80%" align="left">
        <div class="form-inline">
            <input  type="text" name="numi" value ="" class="form-control from-control-sm" onChange='cal_prices();'>
        </div>
    </td>
</tr>
<tr>
    <td width="20%" class="info mycolor2" style="vertical-align:middle">금액</td>
    <td width="80%" align="left">
        <div class="form-inline">
            <input  type="text" name="prices" value ="" class="form-control from-control-sm" readonly style="border:0">
        </div>
    </td>
</tr>
<tr>
    <td width="20%" class="info mycolor2" style="vertical-align:middle">비고</td>
    <td width="80%" align="left">
        <div class="form-inline">
            <input  type="text" name="bigo" value ="" class="form-control from-control-sm" >
        </div>
    </td>
</tr>
</table>
