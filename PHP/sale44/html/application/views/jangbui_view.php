...
<tr>
    ...
    <td width="80%" align="left">
		...
		<div align="center">
			<a href="/~sale44/jangbui/edit<?=$tmp; ?>" class="btn btn-sm mycolor1">수정</a>
			<a href="/~sale44/jangbui/del<?=$tmp; ?>" class="btn btn-sm mycolor1" onClick="return confirm('삭제할까요?');">삭제</a>&nbsp;
