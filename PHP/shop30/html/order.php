...
if ($cookie_no)     // 쿠키로 로그인했는지 조사
{
 ...
 $row3=mysqli_fetch_array($result);
  ...
  $tel1=trim(substr($row3[tel30],0,3));
  $tel2=trim(substr($row3[tel30],3,4));
  $tel3=trim(substr($row3[tel30],7,4));        

  $phone1=trim(substr($row3[phone30],0,3));
  $phone2=trim(substr($row3[phone30],3,4));
  $phone3=trim(substr($row3[phone30],7,4));  
}
						...
						<table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr height="25">
								...
								<td width="390">
									...
									<input type="text"   name="o_name" size="20" maxlength="10" value="<?=$row3[name30]?>" class="cmfont1">
								</td>
							</tr>
							<tr height="25">
							...
							<tr height="25">
								...
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="text" name="o_email" size="50" maxlength="50" value="<?=$row3[email30]?>" class="cmfont1">
								</td>
							</tr>
							<tr height="50">
								...
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="text" name="o_zip" size="5" maxlength="5" value="<?=$row3[zip30]?>" class="cmfont1"> 
									<a href="javascript:FindZip(1)"><img src="images/b_zip.gif" align="absmiddle" border="0"></a> <br>
									<input type="text" name="o_juso" size="55" maxlength="200" value="<?=$row3[juso30]?>" class="cmfont1"><br>
								</td>
							</tr>
						</table>
