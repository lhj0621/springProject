...
<tr bgcolor='#F2F2F2'>
   <td width='100' align='center'>&nbsp $row[no30]</td>
    <td width='100'  align='left'>&nbsp $row[name30]</td>
		<td align='center'>
	<a href='opt_edit.php?no=$row[no30]'> 수정</a>
	/
	<a href='opt_delete.php?no=$row[no30]'onClick='javascript:return confirm(\"삭제할까요?\");'>삭제</a>
	</td>
	<td align='center'>
	<a href='opts.php?no1=$row[no30]'>소옵션편집<a>
	</td>
