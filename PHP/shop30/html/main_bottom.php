	...
	<tr> 
		<td> 
			<table width="959" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td valign="top"><a href="index.html"><img src="images/footer_logo.gif" border="0" width="190"  height="80"></a></td>
					<td width="28"></td>
					<td> 
						<table border="0" cellspacing="0" cellpadding="0">
							...
							<tr> 
								<td><img src="images/footer_copyright.gif" width="565"  height="140"></td>
							</tr>
						</table>
					</td>
